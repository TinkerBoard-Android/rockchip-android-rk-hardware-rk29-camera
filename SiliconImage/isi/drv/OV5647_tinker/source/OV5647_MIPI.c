 ...
 *****************************************************************************/
CREATE_TRACER( Sensor_INFO , "OV5647: ", INFO,    0U );
CREATE_TRACER( Sensor_WARN , "OV5647: ", WARNING, 1U );
CREATE_TRACER( Sensor_ERROR, "OV5647: ", ERROR,   1U );

CREATE_TRACER( Sensor_DEBUG, "OV5647: ", INFO,     0U );

CREATE_TRACER( Sensor_REG_INFO , "OV5647: ", INFO, 0);
CREATE_TRACER( Sensor_REG_DEBUG, "OV5647: ", INFO, 0U );
 ...
 *****************************************************************************/
const char Sensor_g_acName[] = "OV5647_MIPI";
	...
	if(pSensorCtx->IsiSensorMipiInfo.ucMipiLanes == SUPPORT_MIPI_ONE_LANE){
	    ...
	    switch ( pConfig->Resolution )
	    {
	        ...
	        case ISI_RES_2592_1944P15:
	        {
				...
				pSensorCtx->IsiSensorMipiInfo.ulMipiFreq = 210;
				#else
				pSensorCtx->IsiSensorMipiInfo.ulMipiFreq = 400;
				#endif
	            break;
