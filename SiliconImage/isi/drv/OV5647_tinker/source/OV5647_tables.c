...
const IsiRegDescription_t Sensor_g_aRegDescription_twolane[] =
{
	...
	{0x3016, 0x08,"0x0100",eReadWrite}, // fine tune by ASUS
...
//	{0x380d,0x56,"0x0100",eReadWrite},//00
	...
	//{0x0100, 0x01,"0x0100",eReadWrite},
#if 1 // fine tune by ASUS
	{0x5000,0x06,"0x0100",eReadWrite},//lenc WBC on
	{0x3600,0x37,"0x0100",eReadWrite},// analog control
	{0x3612,0x59,"0x0100",eReadWrite},// analog control
	{0x3618,0x00,"0x0100",eReadWrite},// analog control
	{0x3620,0x64,"0x0100",eReadWrite},// analog control
	{0x3621,0xe0,"0x0100",eReadWrite},// analog control
	{0x3630,0x2e,"0x0100",eReadWrite},// analog control
	{0x3632,0xe2,"0x0100",eReadWrite},// analog control
	{0x3633,0x23,"0x0100",eReadWrite},// analog control
	{0x3634,0x44,"0x0100",eReadWrite},// analog control
	{0x3703,0x5a,"0x0100",eReadWrite},// analog control
	{0x3704,0xa0,"0x0100",eReadWrite},// analog control
	{0x3705,0x1a,"0x0100",eReadWrite},// analog control
	{0x3708,0x64,"0x0100",eReadWrite},// analog control
	{0x3709,0x52,"0x0100",eReadWrite},// analog control
	{0x370b,0x60,"0x0100",eReadWrite},// analog control
	{0x370c,0x0f,"0x0100",eReadWrite},// analog control
	{0x3715,0x78,"0x0100",eReadWrite},// analog control
	{0x3717,0x01,"0x0100",eReadWrite},// analog control
	{0x3731,0x02,"0x0100",eReadWrite},// analog control
#endif
	{0x0000 ,0x00,"eTableEnd",eTableEnd}
#endif
...
//	{0x0100,0x01,"0x0100",eReadWrite}, 
	...
	{0x380c, 0x0a,"0x0100",eReadWrite}, // hts = 2700
	{0x380d, 0x8c,"0x0100",eReadWrite}, // hts
	{0x380e, 0x07,"0x0100",eReadWrite}, // vts = 1974
	{0x380f, 0xb6,"0x0100",eReadWrite}, // vts
	...
	{0x4837, 0x17,"0x0100",eReadWrite}, // MIPI global timing
	{0x0000, 0x64,"0x0100",eDelay}, // delay 100ms workaround for stability
	//{0x0100, 0x01,"0x0100",eReadWrite}, 
	{0x0000 ,0x00,"eTableEnd",eTableEnd}
#endif
};
